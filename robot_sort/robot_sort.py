    ...
    def sort(self):
        ...
        while self.light_is_on():
            ...
            while self.light_is_on() is False:
                # move left until we hit None 
                while self.compare_item() is not None:
                    self.move_left()
                # once we hit None, swap
                # print(f"light off before swap: {l}")
                self.swap_item()
                # print(f"light off after swap: {l}")
                # once we swap, break the loop
                self.set_light_on()
                
            # move the robot right
            self.move_right()
            # if we can't move right, turn off the light
